...
#define STRING_CONFIG_H_AUTHOR "(fm, SAV MkI-lewihe Play)" //Who made the changes.
...
//#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  //    O-- FRONT --+
  //  (0,0)
  #define X_PROBE_OFFSET_FROM_EXTRUDER -35  // X offset: -left  [of the nozzle] +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 0  // Y offset: -front [of the nozzle] +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.450   // Z offset: -below [the nozzle] (always negative!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 4000, 127.5}       // default steps per unit for ultimaker
